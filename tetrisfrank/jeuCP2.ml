...
;;
(*fonction qui retourn coordonné aléatoirement pour la bomb. Position forcement au dessus de l'espace déjà occupé d'où l'appel à la fonction highest_y() ( + 1 car nous ne voulons pas que bomb remplace une case occupé)*)
